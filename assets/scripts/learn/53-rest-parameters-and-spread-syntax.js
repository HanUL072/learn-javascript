// -------------------------------------------------------
// 📌 나머지 매개변수 / 전개 구문 (Reset Prameters and Spread Syntax)
// --------------------------------------------------------
...
;(() => {
  ...
  // 전개 구문 활용
  console.log(...breads) // cosole.log(breads[0], breads[1], breads[2])
...
// HTMLCollection of NodeList -> Array 변환
...
;(() => {
  ...
  // 나머지 매개변수
  // 화살표 함수 -> arguments 를 사용할 수 없음 ()
  // function logNames() {
  //   /* 인자(arguments): 매개변수의 집합*/
  //   // console.log(arguments)
  //   // argument = 유사배열, 배열이 아님
